...
export default function Hero() {
  const [typingMsg, setTypingMsg] = useState('Working on your project…')
  ...
  return (
    <section className="relative min-h-screen flex flex-col justify-center overflow-hidden pt-[68px]" id="about">
      ...
      <div className="absolute inset-0 pointer-events-none z-0">
        <div className="absolute w-[500px] h-[500px] rounded-full opacity-50 animate-blob-1 top-[-100px] right-[-60px]"
      ...
      <div className="relative z-10 max-w-[1140px] mx-auto w-full px-7 py-12 grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
        ...
        >
            ...
            {[
              ...
              <span
                ...
                className="flex items-center gap-1.5 bg-white/80 border border-[#E4E8EF] backdrop-blur-sm
                           px-3.5 py-1.5 rounded-full text-[12.5px] font-medium text-ink-mid"
              >
          ...
          <motion.div variants={item} className="flex flex-wrap justify-center lg:justify-start gap-3">
            <a href="#contact" className="btn-primary shadow-glow-blue hover:shadow-glow-blue-lg">
              Start a Project
            ...
            <div className="bg-white/90 backdrop-blur-xl border border-white rounded-[26px] p-7 shadow-card-xl">
              ...
              <div className="relative flex justify-center">
                <motion.img
                  ...
                  className="w-full max-w-[240px] h-auto animate-float drop-shadow-lg"
                ...
                {chips.map(chip => (
                  <motion.div
                    ...
                    transition={{ duration: 0.5, delay: chip.delay, ease: [0.22,1,0.36,1] }}
                  >
              ...
              <div className="mt-5 pt-4 border-t border-[#E4E8EF] flex items-center gap-2.5">
                <div className="flex gap-1">
                  {[0,200,400].map(d => (
                    <span
                      key={d}
                      className="block w-1.5 h-1.5 rounded-full bg-sky animate-typing"
          ...
          {stats.map((s, i) => (
            <motion.div
              ...
              className="bg-white/70 backdrop-blur-sm border border-[#E4E8EF] rounded-2xl p-5 text-center
                         hover:-translate-y-1 transition-transform duration-200 shadow-[0_1px_4px_rgba(30,58,95,0.06)]"
            >
              <CountUp target={s.count} suffix={s.suffix} />
              <div className="text-[10.5px] uppercase tracking-[1.2px] text-muted font-semibold mt-1.5">{s.label}</div>
            </motion.div>
          ))}
        </div>
      </div>
